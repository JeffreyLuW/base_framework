...
public class ResultVo<T> {
    ...
    public static <T> ResultVo<T> success() {
        return new ResultVo(SUCCESS_CODE, SUCCESS_MSG, SUCCESS_MSG);
    }
    // 成功, 自定义message
    ...
    // 异常
    public static <T> ResultVo<T> handleException(String message) {
        return new ResultVo(EXCEPTION_CODE, message, "");
    }
    // 異常默認
    public static <T> ResultVo<T> handleException() {
