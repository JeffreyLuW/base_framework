...
public class SysDictTypeController extends BaseController
{
    ...
    public AjaxResult add(@Validated @RequestBody SysDictType dict)
    {
        ...
        {
            return AjaxResult.errorWithMsg("新增字典'" + dict.getDictName() + "'失败，字典类型已存在");
        }
        dict.setCreateBy(SecurityUtils.getUsername());
        return rows(dictTypeService.insertDictType(dict));
    }
    ...
    public AjaxResult edit(@Validated @RequestBody SysDictType dict)
    {
        if (UserConstants.NOT_UNIQUE.equals(dictTypeService.checkDictTypeUnique(dict)))
        {
            return AjaxResult.errorWithMsg("修改字典'" + dict.getDictName() + "'失败，字典类型已存在");
        }
        dict.setUpdateBy(SecurityUtils.getUsername());
        return rows(dictTypeService.updateDictType(dict));
    }
    ...
    {
        return rows(dictTypeService.deleteDictTypeByIds(dictIds));
    }
