...
import com.meide.common.core.domain.entity.ManagementEntity;
...
import com.meide.system.mapper.SysDeptMapper;
...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    public SysDept selectDeptById(Long deptId)
    {
        ...
        String deptIntroduction = deptMapper.getDeptIntroduction(deptId);

        if (StringUtils.isNotEmpty(deptIntroduction)) {
            sysDept.setOrganIntroduce(deptIntroduction);
        }
    ...
    public int deleteDeptById(Long deptId) {
        int num = deptMapper.deleteDeptById(deptId);
        deptMapper.deleteManagementById(deptId);
        return num;
    }
