...
import "./assets/styles2/element-variables.scss";
import "./assets/styles2/index.scss"; // global css
import "./assets/styles2/ruoyi.scss"; // ruoyi css
import App from "./App";
...
import globalComponent from "./components2/global/index";
...
Vue.use(Element, {
  size: simple_util.localStorage("size") || "small" // set element-ui default size medium small
});
