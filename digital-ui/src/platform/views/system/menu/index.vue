    ...
    <AutoDialog :title="title" :show.sync="open" width="600px">
      <el-form ref="form" :model="form" :rules="rules">
        <table class="theme-table-form">
          ...
          <tr>
            <td :class="themeTableLabelClass(rules.menuName)">菜单名称</td>
            <td class="theme-table-form__input" key="menuName">
              <el-form-item label="菜单名称" prop="menuName">
          ...
          <tr v-if="form.menuType != 'F'">
            <td class="theme-table-form__label">是否外链</td>
            ...
            <td :class="themeTableLabelClass(rules.path)">路由地址</td>
            <td class="theme-table-form__input">
          ...
          <tr>
            <td v-if="form.menuType == 'C'" :class="themeTableLabelClass(rules.component)">组件路径</td>
            <td v-if="form.menuType == 'C'" class="theme-table-form__input">
              <el-form-item label="组件路径" prop="component">
                <el-input v-model="form.component" placeholder="请输入组件路径"/>
              </el-form-item>
            </td>
            <td v-if="form.menuType != 'M'" class="theme-table-form__label">权限标识</td>
            <td v-if="form.menuType != 'M'" class="theme-table-form__input">
...
<script>
  import {listMenu, getMenu, delMenu, addMenu, updateMenu} from "@/platform/api/system/menu";
  import Treeselect from "@riophae/vue-treeselect";
  import "@riophae/vue-treeselect/dist/vue-treeselect.css";
  import IconSelect from "@/platform/components1/IconSelect";
  ...
  export default {
    ...
    data() {
      let permMap = this.$perm.checkArrayToPermMap([
        {type: 'add', permi: ['system:menu:add']}
      ]);
      return {
        // 遮罩层
        loading: true,
