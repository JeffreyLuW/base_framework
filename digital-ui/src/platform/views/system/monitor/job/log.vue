<template>
  <div class="app-container">
    ...
    <FormToolsRow ref="formToolsRow" @refresh="getList">
      <el-col :span="1.5">
        <el-button
          type="danger"
          icon="el-icon-delete"
...
<script>
  import {listJobLog, delJobLog, exportJobLog, cleanJobLog} from "@/platform/api/monitor/jobLog";
  ...
  export default {
    ...
    mounted() {
      this.$nextTick(() => {
        this.$refs.formToolsRow.computeSearchFormMultiLine();
      });
    },
    methods: {
      /** 查询调度日志列表 */
