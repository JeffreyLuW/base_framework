<template>
  <div class="app-container">
    ...
    <FormToolsRow :buttons="formTools" @click="onClickOps">
      <el-button slot="clearCache" type="danger" icon="el-icon-refresh" size="mini"
    ...
    <AutoDialog :title="title" :show.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules">
        <table class="theme-table-form">
          ...
          <tr>
            <td :class="themeTableLabelClass(rules.configName)">参数名称</td>
          ...
          <tr>
            <td :class="themeTableLabelClass(rules.configKey)">参数键名</td>
            <td class="theme-table-form__input">
              <el-form-item label="参数键名" prop="configKey">
          ...
          <tr>
            <td :class="themeTableLabelClass(rules.configIsImg)">值为图片</td>
            <td class="theme-table-form__input">
              <el-form-item label="值为图片" prop="configIsImg">
                <el-radio-group v-model="form.configIsImg" @change="form.configValue=''">
                  <el-radio
                    v-for="dict in typeOptions"
                    :key="dict.dictValue"
          ...
          <tr>
            <td :class="themeTableLabelClass(rules.configValue)">参数键值</td>
            <td class="theme-table-form__input">
              <el-form-item label="参数键值" prop="configValue">
                <DataUpload v-if="form.configIsImg=='Y'" v-model="form.configValue" :limit="1"
          ...
          <tr>
            <td :class="themeTableLabelClass(rules.configType)">系统内置</td>
            <td class="theme-table-form__input">
              <el-form-item label="系统内置" prop="configType">
...
<script>
  import {
    ...
    exportConfig,
    clearCache
  } from "@/platform/api/system/config";
  ...
  export default {
    ...
    data() {
      let permMap = this.$perm.checkArrayToPermMap([
        {type: 'add', permi: ['system:config:add']},
        {type: 'edit', permi: ['system:config:edit']},
        {type: 'remove', permi: ['system:config:remove']},
        {type: 'export', permi: ['system:config:export']},
        {type: 'clearCache', permi: ['system:config:remove']}
      ]);
      return {
        // 遮罩层
        loading: true,
