<template>
  <div class="app-container">
    ...
    <FormToolsRow :buttons="formTools" @click="onClickOps">
      <el-button slot="clean" type="danger" icon="el-icon-delete" size="mini" @click="handleClean">清空</el-button>
    </FormToolsRow>
    ...
    <!-- 操作日志详细  -->
    <AutoDialog title="操作日志详细" :show.sync="open" width="700px">
...
<script>
  import {list, delOperlog, cleanOperlog, exportOperlog} from "@/platform/api/monitor/operlog";
  ...
  export default {
    ...
    data() {
      let permMap = this.$perm.checkArrayToPermMap([
        {type: 'remove', permi: ['monitor:operlog:remove']},
        {type: 'clean', permi: ['monitor:operlog:remove']},
