...
<script>
  import {list, delLogininfor, cleanLogininfor, exportLogininfor} from "@/platform/api/monitor/logininfor";
  ...
  export default {
    ...
    data() {
      let permMap = this.$perm.checkArrayToPermMap([
        {type: 'remove', permi: ['monitor:logininfor:remove']},
        {type: 'remove', permi: ['monitor:logininfor:remove']},
        {type: 'export', permi: ['system:logininfor:export']}
      ]);
      return {
        // 遮罩层
        loading: true,
