...
import com.meide.system.domain.SysRoleDept;
import com.meide.system.domain.SysRoleMenu;
import com.meide.system.mapper.SysRoleDeptMapper;
import com.meide.system.mapper.SysRoleMapper;
import com.meide.system.mapper.SysRoleMenuMapper;
import com.meide.system.mapper.SysUserRoleMapper;
...
public class SysRoleServiceImpl implements ISysRoleService {
    ...
    public int deleteRoleById(Long roleId) {
        ...
        if (countUserRoleByRoleId(roleId) > 0) {
            ...
            throw new CustomException(StrUtil.format("{}存在用户,不能删除", role.getRoleName()));
        }
