...
public class SysRoleController extends BaseController
{
    ...
    public AjaxResult add(@Validated @RequestBody SysRole role)
    {
        ...
        {
            return AjaxResult.errorWithMsg("新增角色'" + role.getRoleName() + "'失败，角色名称已存在");
        }
        else if (UserConstants.NOT_UNIQUE.equals(roleService.checkRoleKeyUnique(role)))
        {
            return AjaxResult.errorWithMsg("新增角色'" + role.getRoleName() + "'失败，角色权限已存在");
        }
        role.setCreateBy(SecurityUtils.getUsername());
        return rows(roleService.insertRole(role));
    ...
    public AjaxResult edit(@Validated @RequestBody SysRole role)
    {
        ...
        if (UserConstants.NOT_UNIQUE.equals(roleService.checkRoleNameUnique(role)))
        {
            return AjaxResult.errorWithMsg("修改角色'" + role.getRoleName() + "'失败，角色名称已存在");
        }
        else if (UserConstants.NOT_UNIQUE.equals(roleService.checkRoleKeyUnique(role)))
        {
            return AjaxResult.errorWithMsg("修改角色'" + role.getRoleName() + "'失败，角色权限已存在");
        }
        ...
        return AjaxResult.errorWithMsg("修改角色'" + role.getRoleName() + "'失败，请联系管理员");
    }
    ...
    {
        roleService.checkRoleAllowed(role);
        return rows(roleService.authDataScope(role));
    }
    ...
    public AjaxResult changeStatus(@RequestBody SysRole role)
    {
        roleService.checkRoleAllowed(role);
        role.setUpdateBy(SecurityUtils.getUsername());
        return rows(roleService.updateRoleStatus(role));
    }
    ...
    {
        return rows(roleService.deleteRoleByIds(roleIds));
    }
